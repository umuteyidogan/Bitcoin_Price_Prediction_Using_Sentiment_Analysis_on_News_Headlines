...
output_path = "/Users/umuteyidogan/Desktop/IGP_Project/Crypto_Sentiment_Analysis_VADER.xlsx"
df.to_excel(output_path, index=False)

print(f"Analysis results have been saved to {output_path}")

# Save daily sentiment to a new file
daily_sentiment_output_path = "/Users/umuteyidogan/Desktop/IGP_Project/Daily_Sentiment_Analysis_VADER.xlsx"
daily_sentiment.to_excel(daily_sentiment_output_path, index=False)
print(f"Daily sentiment results have been saved to {daily_sentiment_output_path}")
...
plt.title('Sentiment Analysis Distribution (VADER)')
